    ...
    <div class="col-md-8">
        <div class="card mb-4" style="box-shadow: none !important;">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="client_cible" class="form-label">Clients cible</label>
                    <select class="form-select" id="client_cible" name="client_cible" id="client_cible">
